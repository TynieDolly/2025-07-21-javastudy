 ...
 *                   => 일반 실수 => 건축 => 정밀도
 *          논리 저장
 *            boolean => 8bit => 소수점 15자리
 *                    => 일반실수 => 건축 => 정밀도
 *          문자저장
 *            char => 16bit=>  양수만 사용
 *                    0~65535
 *          --------------------------------
 *        참조형 : 여거개 데이터를 저장하는 경우 = 주소
 *               ----------------------
 *               배열 / 클래스
 *                     ----- String 문자열
 *          ** String : 문자열 여러개 저장     
 ...
 *              https://www.google.com/search?q=%EC%9E%90%EB%B0%94&oq=&gs_lcrp=EgZjaHJvbWUqCQgHEEUYOxjCAzIJCAAQRRg7GMIDMgkIARBFGDsYwgMyCQgCEEUYOxjCAzIJCAMQRRg7GMIDMgkIBBBFGDsYwgMyCQgFEEUYOxjCAzIJCAYQRRg7GMIDMgkIBxBFGDsYwgPSAQkzOTUwajBqMTWoAgiwAgE&sourceid=chrome&ie=UTF-8                                 
 *           = 변환
 *              replace : 문자/문자열
 *              --------
